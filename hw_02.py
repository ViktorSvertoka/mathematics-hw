# -*- coding: utf-8 -*-
"""ДЗ2_Свертока_Віктор_Васильович.ipynb"

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Vnw8GgMdtr624hRN7rW_Bj9vddgLXVhc
...
# Розв'язання системи лінійних рівнянь за допомогою методу solve
...
def solve_inv_matrix(A, B, verbose=False):
    """
    Функція для розв'язання системи лінійних рівнянь за допомогою матричного методу (інверсія матриці).
...
def solve_cramer(A, B, verbose=False):
    ...
    if det_A == 0:
        raise ValueError("Система не має єдиного розв'язку, оскільки визначник матриці A дорівнює нулю.")
    ...
    for i in range(n):
        ...
        if verbose:
            print(f"Визначник матриці A{i+1} (заміна стовпця {i+1} на вектор B): {det_Ai}")
